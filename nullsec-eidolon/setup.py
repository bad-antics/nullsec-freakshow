...
setup(
    name="nullsec-eidolon", version="1.0.0",
    description="Ghost Network Packets — Spectral Traffic Analysis",
    ...
    entry_points={"console_scripts": ["eidolon=eidolon.cli:entry_point"]},
)
