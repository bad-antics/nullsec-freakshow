...
setup(
    name="nullsec-harbinger", version="1.0.0",
    description="Log Scream Detector — The Harbinger Hears All",
    ...
    entry_points={"console_scripts": ["harbinger=harbinger.cli:entry_point"]},
)
